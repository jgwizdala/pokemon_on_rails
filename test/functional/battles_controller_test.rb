...
class BattlesControllerTest < ActionController::TestCase
  ...
  test "should create battle" do
    assert_difference('Battle.count') do
      post :create, battle: { complete: @battle.complete, enemy_id: @battle.enemy_id, trainer_id: @battle.trainer_id, turns: @battle.turns }
    end
  ...
  test "should update battle" do
    put :update, id: @battle, battle: { complete: @battle.complete, enemy_id: @battle.enemy_id, trainer_id: @battle.trainer_id, turns: @battle.turns }
    assert_redirected_to battle_path(assigns(:battle))
  end
